...
export const zh_CN: TranslationMap = {
  ...
  workboard: {
    ...
    engineDisabledRuntime:
      "{agent} 使用 {runtime} ACP 运行时，请用默认启动打开该会话。",
    runEngine: "运行 {engine}",
    ...
    dependenciesBlockedTitle: "等待依赖项：{parents}。",
    dependencyMissing: "{parent}（缺失）",
    dependencyStatusMissing: "缺失",
    unknownStatus: "未知",
    showArchived: "显示已归档",
    hideArchived: "隐藏已归档",
    showArchivedShort: "已归档",
    hideArchivedShort: "隐藏归档",
    layout: "卡片布局",
    layoutCompact: "紧凑模式",
    layoutComfortable: "舒适模式",
    dispatch: "提醒调度器",
    dispatchSummary:
      "调度完成：启动 {started}，提升 {promoted}，阻塞 {blocked}，回收 {reclaimed}，编排 {orchestrated}，失败 {failures}。",
    dispatchSummaryEmpty: "调度完成：无就绪工作变更。",
    live: "实时",
    fieldTitle: "标题",
    fieldNotes: "备注",
    fieldStatus: "状态",
  ...
  cron: {
    ...
    jobs: {
      ...
      reset: "重置",
      emptyTitle: "暂无计划任务。",
      emptyHint: "使用自然语言创建一个；高级字段可稍后设置。",
      emptyFilteredHint: "清除或更改筛选条件以查看计划任务。",
      noMatching: "没有匹配的任务。",
      loading: "加载中...",
      loadMore: "加载更多任务",
    },
